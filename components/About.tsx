...
function About() {
  return (
    <motion.section
      //ref={ref}
      className="mb-1 max-w-[45rem] text-center leading-8 sm:mb-20 scroll-mt-17"
    ...
    >
      ...
      <p className="mb-3">
        ...
        about{" "} <span className="font-medium">geography, history, and astronomy</span>. I'm incredibly
        passionate about personal development and learning to live a <span className="font-medium">simple, happy life</span>.
      </p>
    </motion.section>
  )
}
