    ...
    >
      ...
      <div className='mb-4 max-w-[60rem] mx-auto text-center leading-8 sm:mb-4 scroll-mt-28 mt-5'>
        <ul className="flex flex-wrap justify-center gap-2 text-lg text-gray-800">
          {skills.map((skill, i) => (
            <motion.li 
              className="bg-[#CFE2F3] inline-block dark:bg-gray-800 rounded-md px-3 py-1 text-sm text-gray-800 dark:text-gray-200 border border-transparent mb-2 mx-auto sm:mx-0 shadow-md p-6 dark:bg-[#102a43]"
              key={i}
              initial="initial"
